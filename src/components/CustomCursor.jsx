...
const CustomCursor = () => {
    ...
    return (
        <>
            ...
            <motion.div
                className="hidden md:block fixed top-0 left-0 w-10 h-10 border border-[var(--color-silver-gray)] rounded-full pointer-events-none z-[9998] shadow-[0_0_15px_rgba(229,231,235,0.3)] mix-blend-screen"
                style={{
                    x: cursorXSpring,
                    y: cursorYSpring,
                    translateX: '-50%',
